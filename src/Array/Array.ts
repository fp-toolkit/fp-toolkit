...
import type { NonNullish, Predicate, Refinement } from "../prelude"
 ...
 * @group Utils
 */
export const isEmpty = <A>(as: readonly A[]): as is readonly [] =>
    as.length === 0
 ...
 * @group Utils
 */
export const isNonEmpty = <A>(as: readonly A[]): as is NonEmptyArray<A> =>
    as.length > 0
...
export const prepend =
    <A>(a: A) =>
    (as: readonly A[]): NonEmptyArray<A> => [a, ...as]
...
export const concat =
    ...
    (as: readonly A[]): readonly A[] => [...as, ...addToEnd]
...
export const concatFirst =
    ...
    (as: readonly A[]): readonly A[] => [...addToFront, ...as]
 ...
 * @group Utils
 */
export const flatten = <A>(as: readonly (readonly A[])[]): readonly A[] =>
    as.flat()
    ...
    (as: readonly A[]): readonly A[] =>
        isEmpty(as)
            ...
            : as
                  .slice(0)
                  .sort((o1: A, o2: A) =>
                      orderingComparer.compare(f(o1), f(o2))
                  )
