...
describe("Result", () => {
    ...
    describe("map3", () => {
        ...
        it.each([
            ...
            [
                [Result.ok(20), Result.err("err1"), Result.err("err2")],
                Result.err("err1"),
            ],
            [
                [Result.err("err1"), Result.ok(20), Result.err("err2")],
                Result.err("err1"),
            ],
            [
                [Result.err("err1"), Result.err("err2"), Result.ok(20)],
                Result.err("err1"),
            ],
            [
                [Result.err("err"), Result.ok(10), Result.ok(20)],
                Result.err("err"),
            ],
            [
                [Result.ok(10), Result.ok(20), Result.err("err")],
                Result.err("err"),
            ],
        ] as const)(
    ...
    describe("getEqualityComparer", () => {
        it.each([
            ...
            [
                false,
                "both are Errs but are not equal",
                Result.err(1),
                Result.err(2),
            ],
            [
                false,
                "one is an Ok and one is an Err",
                Result.ok(1),
                Result.err(1),
            ],
            [
                false,
                "one is an Err and one is an Ok",
                Result.err(1),
                Result.ok(1),
            ],
            ...
            [
                false,
                "both are Oks but are not equal",
                Result.ok(1),
                Result.ok(2),
            ],
        ])(
