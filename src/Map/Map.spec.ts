...
import type { OrderingComparer } from "../OrderingComparer"
...
describe("Map", () => {
    ...
    describe("findWithKey", () => {
        it("returns None if the map is empty", () => {
            expect(
                pipe(new globalThis.Map(), Map.findWithKey("Abby"))
    ...
    describe("containsKey", () => {
        it.each([
            ...
            (expected, letter) => {
                ...
                expect(pipe(letterCounts, Map.containsKey(letter))).toBe(
                    expected
                )
            }
        )
        ...
        it.each([
            ...
            (expected, key) => {
                ...
                expect(
                    pipe(
                        cheeseRankings,
                        Map.containsKey(key, cheeseEqualityComparer)
                    )
                ).toBe(expected)
            }
        )
    ...
    describe("find", () => {
        it.each([
            ...
            (expected, letter) => {
                ...
                expect(pipe(letterCounts, Map.find(letter))).toStrictEqual(
                    expected
                )
            }
        )
    ...
    describe("keys", () => {
        it.each([
            ...
            (_, bindings, expected) => {
                expect(pipe(Map.ofArray(bindings), Map.keys())).toStrictEqual(
                    expected
                )
            }
        )
    ...
    describe("values", () => {
        it.each([
            ...
            (_, bindings, expected) => {
                expect(pipe(Map.ofArray(bindings), Map.values())).toStrictEqual(
                    expected
                )
            }
        )
