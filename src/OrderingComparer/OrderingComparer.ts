...
export const reverse = <A>({
    compare,
}: OrderingComparer<A>): OrderingComparer<A> =>
 ...
 * @group Primitives
 */
export const Date: OrderingComparer<Date> = deriveFrom(Number, date =>
    date.valueOf()
)
...
export const isBetween =
    ...
    (a: A): boolean =>
        geq(orderingComparer)(a, lowerBound) &&
        leq(orderingComparer)(a, upperBound)
